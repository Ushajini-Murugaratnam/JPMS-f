          ...
          <?php     
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Sign up</p>
                  ...
                  <div class="row d-flex justify-content-center">
                    <div class="col-lg-10">
                      <form name="reg" action="Manage/profileManage.php" enctype="multipart/form-data" onsubmit="return validateForm()" method="post" id="reg"  class="row g-3 needs-validation" novalidate>
                            <!-- 2 column grid layout with text inputs for the first and last names -->
                            <div class="row">
                              <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                  <input type="text" id="seeker_fname" name="seeker_fname" class="form-control" required />
                              ...
                              <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                  <input type="text" id="seeker_lname" name="seeker_lname" class="form-control" required />
