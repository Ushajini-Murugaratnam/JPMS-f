    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      ?>
            ...
            <form action="logincheck.php" method="POST" id="signin" id="login">
              ...
              <p class="text-dark-50 mb-3">Please enter your login and password!</p>
              ...
              <button class="btn btn-outline-light btn-lg px-2" type="submit"name="login_btn"   value="Login" id="st-btn">Login</button>
