                ...
                <div class="card shadow mb-4">
                    <!-- User Details Table -->
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Reject Application Reports </h6>
                         </div>
                    ...
                    <!-- Card Body -->
                        <div class="card-body">                                
                                ...
                                <?php
                                      ...
                                      $displaySql="SELECT * FROM  `tbl_job_application` where seeker_id = $loggedin_id and status='0'";
