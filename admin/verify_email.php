...
{
    $token=$_GET['token'];
    $verify_token_query="SELECT verify_token,verify_status FROM tbl_admin where verify_token='$token' LIMIT 1";
    ...
    if(mysqli_num_rows($verify_token_query_run)>0)
    {
        ...
        if($row['verify_status']==0){
            ...
            $update_query="UPDATE tbl_admin SET verify_status='1' WHERE verify_token='$clicked_token' LIMIT 1";
